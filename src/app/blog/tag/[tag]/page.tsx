      ...
      <div className="bg-gradient-to-r from-navy-900 to-navy-800 text-white pt-32 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="max-w-3xl">
            <div className="flex items-center gap-3 mb-4">
              <span className="px-4 py-2 bg-gold-500/10 text-gold-400 rounded-full text-sm font-medium flex items-center gap-2">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16">
        {posts && posts.length > 0 ? (
          ...
          <div className="text-center py-16">
            ...
            <h2 className="text-2xl font-bold text-navy-900 mb-2">No articles found</h2>
            <p className="text-navy-600 mb-8">
              There are no articles tagged with "{decodedTag}" yet.
            </p>
            <Link
              href="/blog"
