...
import { User, Bell, Search, LogOut, Settings, HelpCircle } from 'lucide-react'
          ...
          <div className="relative">
            ...
            {showUserMenu && (
              <div className="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-lg border border-slate-200 py-2">
                <a href="/admin/settings" className="flex items-center gap-2 px-4 py-2 text-sm text-navy-700 hover:bg-slate-50">
                  <Settings className="w-4 h-4" />
                  Settings
                </a>
                <a href="/admin/support" className="flex items-center gap-2 px-4 py-2 text-sm text-navy-700 hover:bg-slate-50">
